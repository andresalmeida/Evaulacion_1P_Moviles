...
class _PaginaRecursosState extends State<PaginaRecursos> {
  ...
  void initState() {
    ...
    _controller2 = YoutubePlayerController(
      initialVideoId: 'UyBylKQwXMU', // Reemplaza con el ID del video 2
      flags: YoutubePlayerFlags(
        autoPlay: false,
        mute: false,
      ),
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            _buildVideoSection('¿Qué es una decena?', _controller1),
            SizedBox(height: 16.0),
            _buildVideoSection('¿Qué es una centena?', _controller2),
            SizedBox(height: 16.0),
            _buildVideoSection('Unidades, decenas y centenas', _controller3),
            SizedBox(height: 16.0),
          ],
        ),
      ),
